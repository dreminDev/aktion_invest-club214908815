...
const {
    amountAction,
    perDayIncAction,
} = require('../../../handlers/usecase/purchases/amount.json');
    ...
    try {
        ...
        switch (status) {
            case 'error':
                ...
                await dbUser.incUserWithdrawalBalance(
                    transaction.recipientId,
                    transaction.amount * courseOutput,
                );
            ...
            default:
                vkShort.sendMsg(
                    transaction.recipientId,
                    `🎉 Успешный вывод. Оставьте пожалуйста отзыв - https://vk.com/topic-214908815_48989783`,
                );
                break;
        }
    } catch (error) {
